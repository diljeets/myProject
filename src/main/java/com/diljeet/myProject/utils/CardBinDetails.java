...
public class CardBinDetails {
    ...
    public CardBinDetails(){        
    }
    
    public CardBinDetails(String issuingBank, String issuingBankCode, String paymentMode, String channelName, String channelCode, String isCvvRequired, String isExpRequired, String isActive, String hasLowSuccessRateStatus, String hasLowSuccessRateMsg, String cardIconUrl) {
